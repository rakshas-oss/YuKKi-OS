...
int main(int argc, char* argv[]) {
 ...
 if (get_config_value(g_config_file, "fancy_prompt", fancy_prompt_str, sizeof(fancy_prompt_str))) {
 ...
 printf("Yukki OS Client 3.2 (Final Integrated Edition) started. Type 'help' for commands.\n");
 char* line_buf; 
 ...
 while (!g_stop_client) {
     ...
     if (g_fancy_prompt) {
         ...
         snprintf(prompt_buf, sizeof(prompt_buf), 
                  "\x1B[36m[%s]\x1B[0m \x1B[33m%s\x1B[0m \x1B[32m✔\x1B[0m > ", 
...
read -p "Enable enhanced visual prompt? (yes/no) [default: no]: " FANCY_PROMPT
# --- [3.2 END] ---
