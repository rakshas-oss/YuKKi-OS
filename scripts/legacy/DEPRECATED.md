...
The scripts in this directory correspond to deprecated versions of YuKKi OS that have been superseded by v6.6.4 Apex Synthesis Edition.
...
For the current deployment script, see [`../deploy/deploy_yukki_6_6_4_apex.zsh`](../deploy/deploy_yukki_6_6_4_apex.zsh).
