...
v6.6.6 (Inet3 Edition) is a production release consolidating the v6.6.x development stream. It focuses on secure ephemeral key handling, improved isolated WebAssembly execution, hardware-tuned ADI integration, deterministic volatile-memory wiping, and operational failsafes for chaotic attractor divergence.

This release also finalizes documentation alignment for branch v6.6.6 by replacing Apex branding references with Inet3 naming across README and docs.
